...
with col1:
    if st.button("< Previous Page"):
           st.switch_page("pages/13_Life expectancy - Healthcare expenditure Introduction.py")

    # This is the subtitle (not clickable)
    st.caption("Life expectancy - Healthcare expenditure Introduction")
with col2:
    # This makes "Next Article >" clickable
    if st.button("Next Page >"):
        st.switch_page("pages/15_Life expectancy - Healthcare expenditure Country Comparison.py")

    # This is the subtitle (not clickable)
    st.caption("Life expectancy - Healthcare expenditure Country Comparison.")
