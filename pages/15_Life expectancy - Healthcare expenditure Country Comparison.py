...
with col1:
    if st.button("< Previous Page"):
           st.switch_page("pages/14_Life expectancy - Healthcare expenditure Relationship.py")

    # This is the subtitle (not clickable)
    st.caption("Life expectancy - Healthcare expenditure Relationship")
with col2:
    # This makes "Next Article >" clickable
    if st.button("Next Page >"):
        st.switch_page("pages/16_Life expectancy - Healthcare expenditure Group Income Analysis.py")

    # This is the subtitle (not clickable)
    st.caption("Life expectancy - Healthcare expenditure Group Income Analysis.")